...
rds_config = { identifier = "blog-dev-db", instance_class = "db.t3.micro", db_name = "wordpress_db", db_username = "admin", db_password = "Alienpython123", snapshot_arn = "arn:aws:rds:us-east-1:227764537934:snapshot:wordpressinstance2", multi_az = false, skip_final_snapshot = true, publicly_accessible = false }
